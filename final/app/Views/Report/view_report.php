        ...
        <div class="card mb-3">
            ...
            <div class="table-responsive">
                <table class="table table-vcenter card-table mb-0">
                    <tbody>
                        <tr>
                            <td style="width: 25%;"><strong>Report ID</strong></td>
                            <td><span class="badge bg-blue">#<?= esc($rep['report_id']) ?></span></td>
                        </tr>
                        <tr>
                            <td><strong>Report Type</strong></td>
                            <td><span class="badge bg-secondary"><?= esc(ucfirst(str_replace('_', ' ', $rep['report_type']))) ?></span></td>
                        </tr>
                        <tr>
            ...
            <?php if($report_type === 'patient'): ?>
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Total Patients: <strong><?= $report_data['total_patients'] ?? 0 ?></strong></p>
                    </div>
            ...
            <?php if($report_type === 'consultation'): ?>
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Total Consultations: <strong><?= $report_data['total_consultations'] ?? 0 ?></strong></p>
                    </div>
                        ...
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-secondary"><?= esc(ucfirst($i['category'])) ?></span></td>
                                    <td>
            ...
            <?php if($report_type === 'announcement'): ?>
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0">Total Announcements: <strong><?= esc($report_data['total_announcements']) ?></strong></p>
                    </div>
            ...
            <?php if($report_type === 'comprehensive'): ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 col-lg-3 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="text-muted text-uppercase mb-2">Total Patients</div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="text-muted text-uppercase mb-2">Consultations</div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="text-muted text-uppercase mb-2">Appointments</div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-3">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="text-muted text-uppercase mb-2">Inventory Items</div>
