...
<div class="card">
    <div class="card-body">
        <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <h5 class="text-muted mb-1">User ID</h5>
                        <p class="mb-0"><?= ($p['user_id'] !== null) ? '<span class="badge bg-secondary">' . esc($p['user_id']) . '</span>' : '<span class="badge bg-light-secondary">Walk-In</span>' ?></p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h5 class="text-muted mb-1">Middle Name</h5>
                    ...
                    <div class="col-md-6">
                        <h5 class="text-muted mb-1">Gender</h5>
                        <p class="mb-3">
                            <span class="badge bg-secondary"><?= ucfirst(esc($p['gender']))?></span>
                        </p>

                        <h5 class="text-muted mb-1">Birth Date</h5>
                        <p class="mb-3"><?= esc($p['birth_date'] ?? 'N/A') ?></p>

                        <h5 class="text-muted mb-1">Blood Type</h5>
                        <p class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="text-muted mb-1">Contact Number</h5>
                    ...
                    <div class="col-md-6">
                        ...
                        <h5 class="text-muted mb-1">Date Added</h5>
